  ...
  return (
    <div className="App">
      <section className="max-w-xl mx-auto mt-32 px-8">
        ...
        <p className="mb-4 leading-7">In the meantime, here's my <a href="https://github.com/msunji">Github account</a>. Always open to doing more front-end work, as well as English-Filipino/Tagalog translations.</p>
      </section>
    </div>
  );
}
